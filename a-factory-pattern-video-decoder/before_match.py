...
def main():
    ...
    while True:
        ...
        if export_quality in {"","low", "high", "master"}:# "" is default to master
            break
        print(f"Unknown output quality option: {export_quality}.")
    # print("hello")# create the video and audio exporters
    video_exporter: VideoExporter
    audio_exporter: AudioExporter
    # good way to reinforce learning is to practice.
    # good way to NOT get a job is to refactor with another less optimal solution. 
    
    match export_quality:
        case "low":
            print("low case")
        ...
        case _: 
            ("Sorry no match for you. Stay single.")
